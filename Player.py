class Player:
    def __init__(self, name, symbol, is_ai=False, algorithm="minimax"):
        self.name = name
        self.symbol = symbol
        self.is_ai = is_ai
        self.algorithm = algorithm  # Choose between "minimax", "alphabeta", or "expected_minimax"
    ...
    def make_move(self, board):
        if self.is_ai:
            ...
            if self.algorithm == "minimax":
                score, col = self.minimax(board, depth=4, maximizing=True, indent=0)
            elif self.algorithm == "alphabeta":
                score, col = self.minimax_with_alphabeta(board, depth=4, maximizing=True, alpha=float('-inf'), beta=float('inf'), indent=0)
            elif self.algorithm == "expected_minimax":
                score, col = self.expected_minimax(board, depth=4, maximizing=True, indent=0)
    ...
    def minimax(self, board, depth, maximizing, indent=0):
        ...
        if maximizing:
            ...
            for col in valid_moves:
                ...
                eval_score, _ = self.minimax(board, depth - 1, False, indent + 1)
                board.undo_move(col)
            ...
            for col in valid_moves:
                ...
                print(f"{prefix}Exploring move at column {col}")
                eval_score, _ = self.minimax(board, depth - 1, True, indent + 1)
                board.undo_move(col)
    ...
    def minimax_with_alphabeta(self, board, depth, maximizing, alpha, beta, indent=0):
        ...
        if maximizing:
            ...
            for col in valid_moves:
                board.play_disc(self, col)
                print(f"{prefix}Exploring move at column {col}")
                eval_score, _ = self.minimax_with_alphabeta(board, depth - 1, False, alpha, beta, indent + 1)
                board.undo_move(col)
            ...
            for col in valid_moves:
                ...
                board.play_disc(opponent, col)
                print(f"{prefix}Exploring move at column {col}")
                eval_score, _ = self.minimax_with_alphabeta(board, depth - 1, True, alpha, beta, indent + 1)
                board.undo_move(col)
        ...
        for col in valid_moves:
            ...
            for i, prob in zip([0, -1, 1], [0.6, 0.2, 0.2]):  # current, left, right
                ...
                if 0 <= target_col < board.cols and board.valid_move(target_col):
                    ...
                    eval_score, _ = self.minimax(board, depth - 1, not maximizing, indent + 1)
